...
@section('title', __('Project Auto Approval Settings'))
@section('style')
    <x-media.css/>
@endsection
@section('content')
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('Project Auto Approval Settings') }}</h4>
                        </div>
                        <x-validation.error />
                        <div class="customMarkup__single__inner mt-4">
                            <x-notice.general-notice
                                    :class="'mt-5'"
                                    :description="__('Notice: Project Auto Approval Settings refer to the automatic publication of a project as soon as a freelancer posts it.')"
                            ...
                            <form action="{{route('admin.project.approval.settings')}}" method="POST">
                                ...
                                <div class="single-input my-5">
                                    <label class="label-title">{{ __('Project Auto Approval') }}</label>
