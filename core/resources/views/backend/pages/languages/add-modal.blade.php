    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">{{ __('Add New Language') }}</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{route('admin.languages.add')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="single-input">
                        <label for="name" class="label-title mt-3">{{__('Language')}}</label>
                    ...
                    <div class="single-input">
                        <label for="direction" class="label-title mt-3">{{__('Direction')}}</label>
                    ...
                    <div class="single-input">
                        <label for="status" class="label-title mt-3">{{__('Status')}}</label>
                ...
                <div class="modal-footer">
                    ...
                    @can('language-add')
                    <x-btn.submit :title="__('Save')" :class="'btn btn-primary mt-4 pr-4 pl-4 add_language'" />
                    @endcan
                </div>
            </form>
        </div>
