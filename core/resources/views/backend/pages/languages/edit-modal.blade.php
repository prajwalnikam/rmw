<!-- Country Edit Modal -->
<div class="modal fade" id="editLanguageModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">{{ __('Edit Language') }}</h1>
            ...
            <form action="{{route('admin.languages.update')}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="single-input">
                        <label for="edit_name" class="label-title mt-3">{{__('Languages')}}</label>
