            ...
            <div class="col-lg-12">
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <h4 class="customMarkup__single__title">{{ __('Page Builder') }}</h4>
                        <br>
                        <a class="btn btn-lg btn-secondary btn-sm mb-3 mr-1"  href="{{route('admin.edit.page',$page->id)}}">{{__('Go Back')}}</a>
                        <a class="btn btn-lg btn-primary btn-sm mb-3 mr-1"  href="{{route('admin.page.all')}}">{{__('All pages')}}</a>
