                ...
                <div class="offset-md-3 col-md-6">
                    <div class="login-wrapper">
                        <div class="login-wrapper-contents">
                            ...
                            <form class="login-wrapper-contents-form custom-form signup-forms" method="post" action="{{ route('client._2fa.verify.code') }}">
                                @csrf
                    ...
                    $.ajax({
                        ...
                        success:function (data){
                            ...
                            if (data.status == 'client-login'){
                                ...
                                el.text('{{__('Redirecting')}}..');
                                erContainer.html('<div class="alert alert-'+data.type+'">'+data.msg+'</div>');
                                let redirectPath = "{{route('freelancer.profile')}}";
