<div class="single-profile-settings" id="display_client_profile_info">
    ...
    <div class="single-profile-settings-inner profile-border-top">
        ...
        <div class="single-input">
            <label for="title" class="label-title">{{ __('Company Name') }}</label>
            <input value="{{ Auth::guard('web')->user()->company_name ?? '' }}" class="form-control" readonly
                disabled>
        </div>
        <div class="single-input">
            <label for="title" class="label-title">{{ __('Address') }}</label>
            <input value="{{ Auth::guard('web')->user()->address ?? '' }}" class="form-control" readonly disabled>
        </div>
        <div class="single-input">
            <label for="title" class="label-title">{{ __('GST No') }}</label>
            <input value="{{ Auth::guard('web')->user()->gst_no ?? '' }}" class="form-control" readonly disabled>
        </div>
