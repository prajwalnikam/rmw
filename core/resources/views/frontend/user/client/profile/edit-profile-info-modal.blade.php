...
<form id="edit_profile_form" method="post">
    ...
    <div class="popup-fixed profile-popup">
        <div class="popup-contents">
            ...
            <div class="single-flex-input">
                <x-form.text :title="__('Company Name')" :type="__('text')" :name="'company_name'" :id="'company_name'" :placeholder="__('Type Company Name')" :value="Auth::guard('web')->user()->company_name ?? '' "/>
            </div>
            <div class = "single-flex-input">
                <x-form.text :title="__('Address')" :type="__('text')" :name="'address'" :id="'address'" :placeholder="__('Type Address')" :value="Auth::guard('web')->user()->address ?? '' "/>
            </div>
            <div class="single-flex-input">
                <x-form.text :title="__('GST No')" :type="__('text')" :name="'GST_No'" :id="'GST_No'" :placeholder="__('Type GST No')" :value="Auth::guard('web')->user()->gst_no ?? '' "/>
            </div>
            {{-- <div class="single-flex-input">
                <x-form.text :title="__('Phone Number')" :type="__('text')" :name="'phone_number'" :id="'phone_number'" :placeholder="__('Type Phone Number')" :value="Auth::guard('web')->user()->phone_number ?? '' "/>
            </div> --}}
