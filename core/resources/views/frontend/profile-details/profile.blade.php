        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="single-profile-settings-form custom-form">
                    ...
                    <x-form.text :type="'text'" :title="__('Company Name')" :id="'professional_title'" :class="'form-control'" value="{{ optional($user->user_introduction)->title }}" />
                    <span id="professional_title_char_length_check"></span>
                    <x-form.textarea :type="'text'" :title="__('Intro About Your Company')" :id="'professional_description'" :class="'form-control'" value="{{ optional($user->user_introduction)->description }}" />
