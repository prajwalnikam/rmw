        ...
        <div class="single-profile-settings-thumb">
            <?php if(!empty(Auth::guard('web')->user()->image)): ?>
                <?php if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi'])): ?>
                    <img src="<?php echo e(render_frontend_cloud_image_if_module_exists( 'profile/'. Auth::guard('web')->user()->image, load_from: Auth::guard('web')->user()->load_from)); ?>" alt="<?php echo e(__('profile img')); ?>">
                <?php else: ?>
                    <img src="<?php echo e(asset('assets/uploads/profile/' . Auth::guard('web')->user()->image) ?? ''); ?>" alt="<?php echo e(__('profile img')); ?>">
                <?php endif; ?>
            <?php else: ?>
            ...
            <div class="single-profile-settings-contents-upload">
                <div class="single-profile-settings-contents-upload-btn">
                    <span>
                        ...
                        <?php echo e(__('Change Photo')); ?>

                    </span>
                    <input type="file" name="image" id="profile_photo" class="upload-file">
                </div>
            </div>
            <p class="single-profile-settings-contents-para mt-2"><?php echo e(__('Profile photo recomended size 80x80 pixels')); ?>

            </p>
        </div>
    </div>
    <div class="btn-wrapper">
        <?php $feedback = \App\Models\Feedback::where('user_id',Auth::guard('web')->user()->id)->first() ?>
        <a href="javascript:void(0)" class="btn-profile btn-outline-1 open_freelancer_feedback_modal" data-bs-target="#feedbackModal"
            data-bs-toggle="modal"
           data-feedback-title="<?php echo e($feedback->title ?? ''); ?>"
           data-feedback-description="<?php echo e($feedback->description ?? ''); ?>"
           data-feedback-rating="<?php echo e($feedback->rating ?? ''); ?>"
        >
...
<?php /**PATH /home/piks/Documents/rmwork-zv/core/resources/views/frontend/user/freelancer/profile/profile-photo.blade.php ENDPATH**/ ?>