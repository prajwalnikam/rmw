...
<?php $__env->startSection('site_title',__('Job Details')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb.user-profile-breadcrumb','data' => ['title' => __('Client Job Details'),'innerTitle' => __('Client Job Details')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Client Job Details')),'innerTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Client Job Details'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    ...
                    <div class="col-xl-8 col-lg-9">
                         <div class="profile-wrapper">
                            <div class="myJob-wrapper">
                                <div class="myJob-wrapper-single">
                                    <div class="myJob-wrapper-single-flex flex-between align-items-center">
                                        <div class="myJob-wrapper-single-contents">
                                            <div class="flex-btn">
                                                <span class="myJob-wrapper-single-id job_open_close_location">#000<?php echo e($job_details->id); ?></span>
                                                <div class="flex-btn">
                                                    <span class="myJob-wrapper-single-fixed"><?php echo e(ucfirst($job_details->type)); ?></span>
                                                    <?php if($job_details->on_off == 0): ?>
                                            ...
                                            <h4 class="myJob-wrapper-single-title mt-3"><a href="javascript:void(0)"><?php echo e($job_details->title); ?></a></h4>
                                            <div class="myJob-wrapper-single-list mt-3">
                                                <?php if($job_details->current_status == 1): ?>
                                                    <span class="job-progress"><?php echo e(__('Job in Progress')); ?></span>
                                                <?php endif; ?>
                                                <?php if($job_details->current_status == 2): ?>
                                                    <span class="job-progress"><?php echo e(__('Complete')); ?></span>
                                                <?php endif; ?>
                                                <?php if($job_details->on_off == 1): ?>
                                                    <span class="job_publicPrivate_view"><?php echo e(__('Public')); ?></span>
                                                <?php else: ?>
                                                    <span class="job_publicPrivate_view"><?php echo e(__('Only Me')); ?></span>
                                                <?php endif; ?>
                                                <span class="myJob-wrapper-single-list-para"><?php echo e($job_details->created_at->toFormattedDateString() ?? ''); ?> - <a href="javascript:void(0)"><?php echo e(ucfirst($job_details->level ?? '')); ?> </a></span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="jobFilter-wrapper-item-bottom-list">
                                            <li class="jobFilter-wrapper-item-bottom-list-item">
                                                ...
                                                <?php if($job_details->type == 'hourly'): ?>
                                                    <span class="item-para"><?php echo e(__("Hourly Rate")); ?>: <strong><?php echo e(float_amount_with_currency_symbol($job_details->hourly_rate)); ?></strong></span>
                                                <?php else: ?>
                                                    <span class="item-para"><?php echo e(__("Budget")); ?>: <strong><?php echo e(float_amount_with_currency_symbol($job_details->budget)); ?></strong></span>
                                                <?php endif; ?>
                                            </li>
                                            <li class="jobFilter-wrapper-item-bottom-list-item">
                                                <span class="item-icon">
                                                ...
                                                <span class="item-para"><?php echo e(__('Hired persons')); ?> <strong><?php echo e($hired_freelancer_count); ?></strong></span>
                                            </li>
                                            <li class="jobFilter-wrapper-item-bottom-list-item">
                                                <span class="item-icon">
                                                ...
                                                <span class="item-para"><?php echo e(__('Proposals')); ?> <strong><?php echo e($job_details?->job_proposals?->count()); ?></strong></span>
                                            </li>
                                            <li class="jobFilter-wrapper-item-bottom-list-item">
                                                <span class="item-icon">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <?php if($job_details->type == 'hourly'): ?>
                                                     <span class="item-para"><?php echo e(__("Estimated Hours")); ?>: <strong><?php echo e($job_details->estimated_hours); ?></strong></span>
                                                <?php else: ?>
                                                    <span class="item-para"><?php echo e(__('Job created')); ?> <strong><?php echo e($job_details->created_at->toFormattedDateString()); ?></strong></span>
                                               <?php endif; ?>
                                             </li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul class="jobFilter-wrapper-item-contents-tag">
                                            <?php $__currentLoopData = $job_details->job_skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="categoryWrap-wrapper-item-contents-tag-list">
                                                    <a href="javascript:void(0)"><?php echo e($skill->skill ?? ''); ?></a>
                                                </li>
                                ...
                                <div class="myJob-wrapper-single">
                                    <div class="myJob-wrapper-single-header">
                                        <p class="myJob-wrapper-single-title"><?php echo $job_details->description; ?></p>
                                    </div>
                                    <div class="profile-border-top">
                                        <div class="flex-between job_open_close_btn_location">
                                            <a href="javascript:void(0)" class="job_open_close" data-job-id="<?php echo e($job_details->id); ?>" data-job-on-off="<?php echo e($job_details->on_off); ?>">
                                                <?php if($job_details->on_off == 0): ?>
                                            ...
                                            <?php if(moduleExists('SecurityManage')): ?>
                                                <?php if(Auth::guard('web')->user()->freeze_job == 'freeze'): ?>
                                                    <a href="#" class="btn-profile btn-og-1 <?php if(Auth::guard('web')->user()->freeze_job == 'freeze'): ?> disabled-link <?php endif; ?>">
                                                        <i class="fa-sharp fa-regular fa-pen-to-square"></i><?php echo e(__('Edit Job')); ?>

                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('client.job.edit',$job_details->id)); ?>" class="btn-profile btn-bg-1"> <i class="fa-sharp fa-regular fa-pen-to-square"></i><?php echo e(__('Edit Job')); ?></a>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <a href="<?php echo e(route('client.job.edit',$job_details->id)); ?>" class="btn-profile btn-bg-1"> <i class="fa-sharp fa-regular fa-pen-to-square"></i><?php echo e(__('Edit Job')); ?></a>
                                            <?php endif; ?>
                            ...
                            <div class="myJob-tabs mt-5">
                                <ul class="tabs">
                                    <li data-val="all" class="active filter_proposal"> <?php echo e(__('Proposals')); ?> (<?php echo e($job_details->job_proposals->count() ?? ''); ?>) </li>
                                    <li data-val="hired" class="filter_proposal"> <?php echo e(__('Hired')); ?> (<?php echo e($hired_freelancer_count); ?>) </li>
                                    <li data-val="shortlisted" class="filter_proposal"> <?php echo e(__('Shortlisted')); ?> (<?php echo e($short_listed_freelancer_count); ?>) </li>
                                    <li data-val="interviewing" class="filter_proposal"> <?php echo e(__('Interviewed')); ?> (<?php echo e($interviewed_freelancer_count); ?>) </li>
                                    <input type="hidden" value="<?php echo e($job_details->id); ?>" id="Job_id_for_filter_jobs">
                                </ul>
                                <div class="filter_job_proposal_result">
                                    <?php echo $__env->make('frontend.user.client.job.job-details.proposals', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                                </di>
                            </div>
                        </div>
                                            ...
                                            <?php $__currentLoopData = $job_details?->job_proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($proposal->is_interview_take == 1): ?>
                                                    ...
                                                    <li class="jobFilter-activities-list-item">
                                                        <h6 class="jobFilter-activities-list-title">
                                                            <?php echo e(__('Interviewed')); ?>  <strong><?php echo e($proposal?->freelancer?->fullname); ?></strong>
                                                        </h6>
                                                ...
                                                <?php if($proposal?->is_interview_take == 0 && $proposal?->is_short_listed == 1): ?>
                                                    ...
                                                    <li class="jobFilter-activities-list-item">
                                                        ...
                                                        <p class="jobFilter-activities-list-para">
                                                            <?php echo e($proposal->updated_at?->toFormattedDateString()); ?>
            ...
            <div class="popup-fixed interview-popup">
                <div class="popup-contents">
                    ...
                    <div class="popup-contents-interview profile-border-top">
                        <div class="myJob-wrapper-single-contents">
                            <span class="myJob-wrapper-single-id">#000<?php echo e($job_details->id); ?> </span>
                            <h4 class="myJob-wrapper-single-title mt-3"><a href="javascript:void(0)"><?php echo e($job_details->title); ?></a></h4>
                            <div class="myJob-wrapper-single-list mt-3">
                                <span class="myJob-wrapper-single-list-para"><?php echo e($job_details->created_at->diffForHumans()); ?> - <a href="javascript:void(0)"><?php echo e(ucfirst($job_details->level)); ?> </a></span>
                            </div>
                        </div>
                    </div>
                    <div class="popup-contents-btn flex-between profile-border-top w-100 margin-0">
                        ...
                        <div class="popup-contents-interview-form custom-form w-100">
                            <form action="<?php echo e(route('client.message.send')); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="from_user" id="from_user" value="<?php echo e($job_details->user_id); ?>">
                                <input type="hidden" name="job_id" id="job_id" value="<?php echo e($job_details->id); ?>">
                                ...
                                <div class="single-input mt-0">
                                    ...
                                    <textarea name="interview_message" id="interview_message" cols="30" rows="2" class="form-message" placeholder="<?php echo e(__('E.g.I would you like to invite yo...')); ?>"></textarea>
                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="single-input">
                                    ...
                                    <input name="hourly_rate" class="form-control" value="<?php echo e($job_details->hourly_rate); ?>">
                                </div>
                                <div class="single-input mt-2">
                                    <label class="label-title mb-2"><?php echo e(__('Estimated Hours')); ?></label>
                                    <input name="estimated_hour" class="form-control" value="<?php echo e($job_details->estimated_hours); ?>">
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/piks/Documents/rmwork-zv/core/resources/views/frontend/user/client/job/job-details/job-details.blade.php ENDPATH**/ ?>