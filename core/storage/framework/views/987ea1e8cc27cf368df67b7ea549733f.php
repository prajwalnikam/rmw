...
<?php $__env->startSection('site_title', __('Add Resources')); ?>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <div>
                <form action="<?php echo e(url('freelancer/resource/import')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <h4><?php echo e(__('Add Resources')); ?></h4>
                </div>
                <div class="card-body">
    ...
    <form action="<?php echo e(url('freelancer/resource/store')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="title"><?php echo e(__('Resource Name')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group" id="custom_role_group" style="display: none;">
                                    <label for="custom_role"><?php echo e(__('Custom Role')); ?></label>
                                    <input type="text" name="custom_role" id="custom_role" class="form-control" value="<?php echo e(old('custom_role')); ?>">
                                    <?php $__errorArgs = ['custom_role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="specification"><?php echo e(__('Specification')); ?></label>
                                    <input type="text" name="specification" class="form-control" value="<?php echo e(old('specification')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="monthly_salary"><?php echo e(__('Monthly Rate')); ?></label>
                                    <input type="text" name="monthly_salary" id="monthly_salary" class="form-control" value="<?php echo e(old('monthly_salary')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="hourly_salary"><?php echo e(__('Hourly Rate')); ?></label>
                                    <input type="text" name="hourly_salary" id="hourly_salary" class="form-control" value="<?php echo e(old('hourly_salary')); ?>">
                                    <?php $__errorArgs = ['hourly_salary'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/piks/Documents/rmwork-zv/core/resources/views/frontend/user/freelancer/resources/add-resources.blade.php ENDPATH**/ ?>