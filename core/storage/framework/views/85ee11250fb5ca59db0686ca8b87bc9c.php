                ...
                <div class="choose-account-flex d-flex mt-4">
                    <div class="choose-account-single selected join_as_a_freelancer">
                        ...
                        <div class="choose-account-single-contents mt-3">
                            <h6 class="choose-account-single-contents-title"><?php echo e(get_static_option('register_page_choose_join_freelancer_title') ?? __('Join as a Loaner')); ?></h6>
                        </div>
                    </div>
                    <div class="choose-account-single join_as_a_client">
                        ...
                        <div class="choose-account-single-contents mt-3">
                            <h6 class="choose-account-single-contents-title"><?php echo e(get_static_option('register_page_choose_join_client_title') ?? __('Join as a borrower')); ?></h6>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/piks/Documents/rmwork-zv/core/resources/views/frontend/user/user-register.blade.php ENDPATH**/ ?>