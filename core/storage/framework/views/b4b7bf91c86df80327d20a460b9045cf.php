    ...
    (function($){
        ...
        $(document).ready(function(){
                    ...
                    success: function(res) {
                        if (res.status == 'success') {
                            ...
                            if(all_subcategories.length <= 0){
                                $(".info_msg").html('<span class="text-danger"> <?php echo e(__('No subcategory found for selected category!')); ?> <span>');
                            }
                        }
                    }
                })
            ...
            function countries(page){
                $.ajax({
                    url:"<?php echo e(route('admin.skill.paginate.data').'?page='); ?>" + page,
                    success:function(res){
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.skill.search')); ?>",
                    method:'GET',
...
<?php /**PATH /home/piks/Documents/rmwork-zv/core/resources/views/backend/pages/skill/skill-js.blade.php ENDPATH**/ ?>