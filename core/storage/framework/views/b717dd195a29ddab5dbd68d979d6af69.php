        ...
        <ul class="single-setup-request-list list-style-none">
            <li class="single-setup-request-list-item running">
                ...
                <div class="single-setup-request-list-item-contents">
                    <h5 class="single-setup-request-list-item-contents-title"><?php echo e(__('About Project')); ?> </h5>
                </div>
            </li>
            <li class="single-setup-request-list-item ">
                <span class="single-setup-request-list-item-number"> 2 </span>
                <div class="single-setup-request-list-item-contents">
                    <h5 class="single-setup-request-list-item-contents-title"><?php echo e(__('About Job')); ?> </h5>
                </div>
            </li>
            <li class="single-setup-request-list-item">
...
<?php /**PATH /home/piks/Documents/rmwork-zv/core/resources/views/frontend/user/client/job/create/job-header.blade.php ENDPATH**/ ?>