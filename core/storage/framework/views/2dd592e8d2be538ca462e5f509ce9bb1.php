    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            $(document).on('change','#category', function() {
                ...
                let jsonOldCategory = <?php echo json_encode(old('subcategory', []), 512) ?>;
                ...
                $.ajax({
                    ...
                    data: {
                        category: category,
                        old_sub_categories: '<?php echo e(json_encode(old('subcategory') ?? [])); ?>'
                    },
...
<?php /**PATH /home/piks/Documents/rmwork-zv/core/resources/views/frontend/pages/jobs/jobs-filter-js.blade.php ENDPATH**/ ?>