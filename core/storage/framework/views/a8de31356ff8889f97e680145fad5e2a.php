...
<?php $__env->startSection('site_title'); ?>
    <?php echo e($job_details->title ?? __('Job Details')); ?>

<?php $__env->stopSection(); ?>
<?php if(isset($job_details->meta_title) && !empty($job_details->meta_title)): ?>
    <?php $__env->startSection('meta_title', $job_details->meta_title); ?>
<?php endif; ?>

<?php if(isset($job_details->meta_description) && !empty($job_details->meta_description)): ?>
    <?php $__env->startSection('meta_description', $job_details->meta_description); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb.user-profile-breadcrumb','data' => ['title' => __('Job Details'),'innerTitle' => __('Job Details')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Job Details')),'innerTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Job Details'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                                ...
                                <div class="jobFilter-wrapper-item-inner">
                                    <div class="jobFilter-wrapper-item-top">
                                        <div class="jobFilter-wrapper-item-top-left">
                                            <h1 class="jobFilter-wrapper-item-title"><?php echo e($job_details->title); ?></h1>
                                            <p class="single-jobs-date">
                                                <?php echo e($job_details->created_at->toFormattedDateString() ?? ''); ?> -
                                                <span><?php echo e(ucfirst(__($job_details->level)) ?? ''); ?></span>
                                            </p>
                                        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.bookmark','data' => ['identity' => $job_details->id,'type' => 'job']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['identity' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($job_details->id),'type' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('job')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                        ...
                                        <div class="obFilter-wrapper-item-contents-flex flex-between">
                                            <?php if($job_details->type == 'hourly'): ?>
                                                <h3 class="single-jobs-price">
                                                    <?php echo e(float_amount_with_currency_symbol($job_details->hourly_rate)); ?> <span
                                                            class="single-jobs-price-fixed"><?php echo e(ucfirst($job_details->type)); ?></span>
                                                </h3>
                                                <?php else: ?>
                                                <h3 class="single-jobs-price">
                                                    <?php echo e(float_amount_with_currency_symbol($job_details->budget)); ?> <span
                                                        class="single-jobs-price-fixed"><?php echo e(ucfirst($job_details->type)); ?></span>
                                                </h3>
                                                <?php endif; ?>
                                        </div>
                                        <div class="single-jobs-para mt-4"><?php echo $job_details->description; ?></div>
                                    ...
                                    <?php if(Auth::guard('web')->check()): ?>
                                        <?php if($job_details->attachment): ?>
                                            <?php if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi'])): ?>
                                                <a href="<?php echo e(render_frontend_cloud_image_if_module_exists('jobs/'.$job_details->attachment, load_from: $job_details->load_from)); ?>"
                                            ...
                                            <?php else: ?>
                                                <?php if(!empty($job_details->attachment) && file_exists(base_path('../assets/uploads/jobs/' . $job_details->attachment))): ?>
                                ...
                                <div class="jobFilter-wrapper-item-bottom">
                                    <ul class="jobFilter-wrapper-item-bottom-list">
                                        <li class="jobFilter-wrapper-item-bottom-list-item">
                                            ...
                                            <span
                                                class="item-para"><?php echo e($job_details->job_creator?->user_country?->country); ?></span>
                                        </li>
                                        ...
                                        <li class="jobFilter-wrapper-item-bottom-list-item">
                                            ...
                                            <span class="item-para"><?php echo e(ucfirst(__($job_details->duration)) ?? ''); ?></span>
                                        </li>
                                        <?php if($job_details->type == 'hourly'): ?>
                                            <li class="jobFilter-wrapper-item-bottom-list-item">
                                            <span class="item-icon">
                                                ...
                                                <span class="item-para"><?php echo e(__('Estimated Hours:')); ?> <?php echo e($job_details->estimated_hours ?? ''); ?></span>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                            ...
                            <?php if(Auth::guard('web')->check() && Auth::guard('web')->user()->user_type == 2 && Session::get('user_role') != 'client' && auth()->user()->id != $job_details->user_id): ?>
                                <?php
                                ...
                                ?>
                                    ...
                                    <div class="jobFilter-wrapper-item">
                                        <div class="jobFilter-wrapper-item-header profile-border-bottom">
                                            <h4 class="profile-wrapper-item-title"> <?php echo e(__('Submit Proposal')); ?> </h4>
                                        </div>
...
<div class="container py-4">
    <h4 class="mb-3"><?php echo e(__('Select Resources for this Proposal')); ?></h4>
                        ...
                        <div class="card-body">
                            <div class="form-check mb-2">
                                <input class="form-check-input resource-checkbox" type="checkbox"
                                       id="resource-<?php echo e($resource->id); ?>" value="<?php echo e($resource->id); ?>"
                                       name="selected_resources[]"> 
                                <label class="form-check-label" for="resource-<?php echo e($resource->id); ?>">
                                    <strong>Select This Resource</strong>
                                </label>
                            </div>
                            <h5 class="card-title"><?php echo e($resource->title); ?></h5>
                            <p class="card-text text-muted"><?php echo e(Str::limit($resource->description, 100)); ?></p>

                            
                            <ul class="list-unstyled mt-3">
                                <?php if($resource->status): ?>
                                    <li><strong>Status:</strong> <span class="badge <?php echo e($resource->status == 'available' ? 'bg-success' : 'bg-warning'); ?>"><?php echo e(ucfirst($resource->status)); ?></span></li>
                                <?php endif; ?>
                                <?php if($resource->role): ?>
                                    <li><strong>Role:</strong> <?php echo e($resource->role); ?></li>
                                <?php endif; ?>
                                <?php if($resource->experience): ?>
                                    <li><strong>Experience:</strong> <?php echo e($resource->experience); ?> years</li>
                                <?php endif; ?>
                                <?php if($resource->monthly_salary): ?>
                                    <li><strong>Monthly Salary:</strong> $<?php echo e(number_format($resource->monthly_salary, 2)); ?></li>
                                <?php endif; ?>
                                <?php if($resource->hourly_salary): ?>
                                    <li><strong>Hourly Salary:</strong> $<?php echo e(number_format($resource->hourly_salary, 2)); ?> / hour</li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    </div>
    ...
    <?php else: ?>
        <div class="alert alert-info" role="alert">
            <?php echo e(__('You have no resources created yet. Please create resources to attach them to proposals.')); ?>
...
<div class="single-input">
    <label class="label-title"> <?php echo e(__('Number of Resources Selected')); ?> </label>
    <input type="number" name="revision" id="revision" class="form--control" readonly
        placeholder="<?php echo e(__('Number of selected resources')); ?>">
</div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="jobFilter-wrapper-item-btn flex-btn justify-content-end">
                                                        <button type="submit"
                                                            class="btn-profile btn-bg-1 send_job_proposal"><?php echo e(__('Send Proposal')); ?> <span id="send_proposal_load_spinner"></span></button>
                                                    </div>
                                                </div>
                                            ...
                                            <form action="<?php echo e(route('job.proposal.send')); ?>" method="post"
                                                            ...
                                                            <div class="single-input">
                                                                ...
                                                                <div class="single-input-icon">
                                                                    <input type="number" name="amount" id="amount"
                                                                           class="form--control" value="<?php echo e($job_details->hourly_rate ?? ''); ?>">
                                                                    <span class="input-icon"><?php echo e(get_static_option('site_global_currency') ?? ''); ?></span>
                                                                </div>
                                                            </div>
                                                        <?php else: ?>
                                                            <div class="single-input">
                                                                <label class="label-title"> <?php echo e(__('Proposal amount')); ?> </label>
                                                                <div class="single-input-icon">
                                                                    <input type="number" name="amount" id="amount"
                                                ...
                                                <div class="single-input">
                                                    ...
                                                    <input type="number" name="revision" id="revision"
                                                           class="form--control"
                                                           placeholder="<?php echo e(__('Job Revision Must be Number')); ?>" onkeypress="inpNum(event)">
                                                </div>

                                                <div class="single-input">
                                                    <label class="label-title"> <?php echo e(__('Your cover letter')); ?> </label>
                                        ...
                                        <div class="jobFilter-about-clients-flex">
                                            <span class="jobFilter-about-clients-thumb">
                                                <?php if($job_details->job_creator?->image): ?>
                                                    <?php if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi'])): ?>
                                                        <img src="<?php echo e(render_frontend_cloud_image_if_module_exists( 'profile/'. $job_details?->job_creator?->image, load_from: $job_details?->job_creator?->load_from ?? '')); ?>" alt="<?php echo e(__('profile img')); ?>">
                                                    <?php else: ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status.user-active-inactive-check','data' => ['userID' => $job_details->job_creator->id]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                                ...
                                                <span><?php echo e($job_details?->job_creator?->user_state?->state); ?> ,
                                                    <?php echo e($job_details?->job_creator?->user_country?->country); ?></span>

                                                <?php if($job_details->job_creator?->user_verified_status == 1): ?>
                                                    <span data-toggle="tooltip" title="<?php echo e(__('User Verified')); ?>"> <i class="fas fa-circle-check"></i> </span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                ...
                                <div class="jobFilter-about-clients">
                                    <div class="jobFilter-about-clients-single flex-between">
                                        ...
                                        <h6 class="jobFilter-about-clients-completed">
                                            <?php echo e($job_details->job_creator?->created_at->toFormattedDateString() ?? ''); ?>
                                ...
                                <div class="jobFilter-about-clients">
                                    <div class="jobFilter-about-clients-single flex-between">
                                        ...
                                        <h6 class="jobFilter-about-clients-completed"><?php echo e($user->user_jobs?->count()); ?>
                                ...
                                <?php if($hiring_rate >= 1): ?>
                                    <div class="jobFilter-about-clients">
                                        <div class="jobFilter-about-clients-single flex-between">
                                            ...
                                            <h6 class="jobFilter-about-clients-completed"><?php echo e(round($hiring_rate) ?? 0); ?>%
                                            </h6>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <?php if($job_details->last_seen != null): ?>
                                    <div class="jobFilter-about-clients">
                                        <div class="jobFilter-about-clients-single flex-between">
                                            <div class="jobFilter-about-clients-flex">
                                                <span class="jobFilter-about-clients-icon">
                                                ...
                                                <span class="jobFilter-about-clients-para"><?php echo e(__('Last seen')); ?></span>
                                            </div>
                                            <h6 class="jobFilter-about-clients-completed">
                            ...
                            <?php if(Auth::guard('web')->check() && Auth::guard('web')->user()->id == $job_details->user_id): ?>
                                
                                <?php if($job_details?->job_proposals->count() >= 1): ?>
                                    <div class="jobFilter-wrapper-item">
                                        <div class="jobFilter-wrapper-item-header profile-border-bottom">
                                            <h4 class="profile-wrapper-item-title"> <?php echo e(__('Activities')); ?> </h4>
                                        </div>
                                                    ...
                                                    <?php if($proposal->is_interview_take == 1): ?>
                                                        ...
                                                        <li class="jobFilter-activities-list-item">
                                                            <h6 class="jobFilter-activities-list-title">
                                                                <?php echo e(__('Interviewed')); ?>

                                                                <strong><?php echo e($proposal?->freelancer?->fullname); ?></strong>
                                                            </h6>
                                                            <p class="jobFilter-activities-list-para">
                                                                <?php echo e($proposal->updated_at?->toFormattedDateString()); ?></p>
                                                        </li>
                                                    <?php endif; ?>
                                                    <?php if($proposal?->is_interview_take == 0 && $proposal?->is_short_listed == 1): ?>
                                                        <?php
                                                            $activity_count++;
                                                        ?>
                                                        <li class="jobFilter-activities-list-item">
                                                            <h6 class="jobFilter-activities-list-title">
                                                                <?php echo e(__('Shortlisted')); ?>
                                ...
                                <?php if($job_details->job_proposals->count() >= 1): ?>
                                    <div class="jobFilter-wrapper-item proposal-padding">
                                        <div class="jobFilter-wrapper-item-header profile-border-bottom">
                                            <h4 class="profile-wrapper-item-title"> <?php echo e(__('All Proposals')); ?> </h4>
                                        </div>
                                        <?php $__currentLoopData = $job_details->job_proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($proposal?->freelancer): ?>
                                                    ...
                                                    <div class="jobFilter-proposal-author-flex">
                                                        <div class="jobFilter-proposal-author-thumb">
                                                            <?php if($proposal->freelancer?->image): ?>
                                                                <img src="<?php echo e(asset('assets/uploads/profile/' . $proposal->freelancer?->image)); ?>"
                                                                    alt="<?php echo e($proposal->freelancer?->fullname); ?>">
                                                            <?php else: ?>
                                                                <img src="<?php echo e(asset('assets/static/img/author/author.jpg')); ?>"
                                                                    alt="<?php echo e(__('AuthorImg')); ?>">
                                                            <?php endif; ?>
...
<?php endif; ?>
                                                            ...
                                                            <p class="jobFilter-proposal-author-contents-subtitle mt-2">
                                                                <?php echo e($proposal->freelancer?->user_introduction?->title ?? ''); ?>

                                                                · <span><?php echo e($proposal->freelancer?->user_state?->state ?? ''); ?>,
                                                                    <?php echo e($proposal->freelancer?->user_country?->country ?? ''); ?></span>
                                                            </p>
                                                            ...
                                                            <p class="jobFilter-proposal-author-contents-time mt-2">
                                                                <?php echo e($proposal->created_at->diffForHumans()); ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="jobFilter-proposal-offered profile-border-top">
                                                    <div class="jobFilter-proposal-offered-single">
                                                        <span class="offered"><?php echo e(__('Offered')); ?> <span
                                                                class="offered-price"><?php echo e(float_amount_with_currency_symbol($proposal->amount)); ?></span>
                                                        </span>
                                                    </div>
                                                    <div class="jobFilter-proposal-offered-single">
                                                        <span class="offered"><?php echo e(__('Est. delivery duration')); ?> <span
                                                                class="offered-days"><?php echo e($proposal->duration); ?></span>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        function inpNum(e) {
            ...
            if (!charStr.match(/^[0-9]+$/)){
                toastr_warning_js("<?php echo e(__('Job revision must be a number.')); ?>")
                e.preventDefault();
            }
        }
    </script>
    <?php echo $__env->make('frontend.pages.job-details.job-details-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/piks/Documents/rmwork-zv/core/resources/views/frontend/pages/job-details/job-details.blade.php ENDPATH**/ ?>