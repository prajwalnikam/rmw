...
Route::group(['middleware' => ['globalVariable', 'maintains_mode','setlang']], function () {
    ...
    Route::get('resources', [FreelancerListController::class, 'talents'])->name('resources.index');
    Route::get('resources/pagination', [FreelancerListController::class, 'pagination'])->name('resources.pagination');
    Route::get('resource/{id}', [FreelancerListController::class, 'show'])->name('resources.show');
    Route::post('resource/{id}/contact', [FreelancerListController ::class, 'contact'])->name('resources.contact');
