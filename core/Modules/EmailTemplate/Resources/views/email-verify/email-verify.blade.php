...
@section('title', __('User Email Verify'))
@section('style')
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('User Email Verify') }}</h4>
                        </div>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <x-validation.error />
                            <form action="{{route('admin.user.verified.mail')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <x-form.text
                                    :title="__('Email Subject')"
                                    :type="__('text')"
                                    :name="'user_email_verified_subject'"
                                    :id="'user_email_verified_subject'"
                                    :value="get_static_option('user_email_verified_subject') ?? __('User Email Verify')"
                                />
                                <x-form.summernote
                                    :title="__('Email Message')"
                                    :name="'user_email_verified_message'"
                                    :id="'user_email_verified_message'"
                                    :value="get_static_option('user_email_verified_message') ?? '' "
                                />
