...
@section('title', __('Disable 2FA Email'))
@section('style')
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('Disable 2FA Email') }}</h4>
                        </div>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <x-validation.error />
                            <form action="{{route('admin.user._2fa.disable.mail')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <x-form.text
                                    :title="__('Email Subject')"
                                    :type="__('text')"
                                    :name="'_2fa_disable_subject'"
                                    :id="'_2fa_disable_subject'"
                                    :value="get_static_option('_2fa_disable_subject') ?? __('Disable 2FA Email')"
                                />
                                <x-form.summernote
                                    :title="__('Email Message')"
                                    :name="'_2fa_disable_message'"
                                    :id="'_2fa_disable_message'"
                                    :value="get_static_option('_2fa_disable_message') ?? '' "
                                />
