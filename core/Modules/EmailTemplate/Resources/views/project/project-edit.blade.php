...
@section('title', __('Project Edit Email'))
@section('style')
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('Project Edit Email') }}</h4>
                        </div>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <x-validation.error />
                            <form action="{{route('admin.user.project.edit')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <x-form.text
                                    :title="__('Email Subject')"
                                    :type="__('text')"
                                    :name="'project_edit_email_subject'"
                                    :id="'project_edit_email_subject'"
                                    :value="get_static_option('project_edit_email_subject') ?? __('Project Edit Email')"
                                />
                                <x-form.summernote
                                    :title="__('Email Message')"
                                    :name="'project_edit_email_message'"
                                    :id="'project_edit_email_message'"
                                    :value="get_static_option('project_edit_email_message') ?? '' "
                                />
