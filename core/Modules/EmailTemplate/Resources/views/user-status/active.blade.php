                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <x-validation.error />
                            <form action="{{route('admin.user.status.active.mail')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <x-form.text
                                    :title="__('Email Subject')"
                                    :type="__('text')"
                                    :name="'user_status_active_subject'"
                                    :id="'user_status_active_subject'"
                                    :value="get_static_option('user_status_active_subject') ?? __('User Status Activate Email')"
                                />
                                <x-form.summernote
                                    :title="__('Email Message')"
                                    :name="'user_status_active_message'"
                                    :id="'user_status_active_message'"
