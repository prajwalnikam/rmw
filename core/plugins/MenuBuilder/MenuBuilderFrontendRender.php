    ...
    public function render_frrontend_panel_menu($id){
        ...
        if (count((array)$menu_data) > 0){
            foreach ($menu_data as $menu_item){
                if ((isset($menu_item->pname) && $menu_item->pname == "Talents" && Session::get('user_role') == 'freelancer') || (isset($menu_item->pname) && $menu_item->pname == "Jobs" && Session::get('user_role') == 'client')) {    
