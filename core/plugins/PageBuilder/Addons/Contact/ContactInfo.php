...
class ContactInfo extends PageBuilderBase
{
    ...
    {
        return 'contact-page/contact-info.png';
    }
    ...
    public function frontend_render()
    {
        ...
        foreach ($repeater_data['title_'] as $key => $title) {
            ...
            $icon = SanitizeInput::esc_html($repeater_data['icon_'][$key]);
            $description_1 = SanitizeInput::esc_html($repeater_data['description_1_'][$key]);
            $description_2 = SanitizeInput::esc_html($repeater_data['description_2_'][$key]);
